      ...
      <div className="row">
        ...
        <div className="col-md-9 main-content">
          <div className="search-header p-3">
            ...
            <div className="price-filters d-flex gap-2 mt-2">
              <input type="number" className="form-control" placeholder="Min price" value={minPrice} onChange={e => { setMinPrice(e.target.value); handlePriceChange(); }} />
              <input type="number" className="form-control" placeholder="Max price" value={maxPrice} onChange={e => { setMaxPrice(e.target.value); handlePriceChange(); }} />
            </div>
          </div>
