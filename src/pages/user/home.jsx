    ...
    <div className="library-homepage">
      ...
      <header className="hero-section">
        ...
        <div className="container hero-content">
          <h1 className="hero-title">Find Your Perfect Study Room</h1>
          <p className="hero-subtitle">Browse and book quiet, private study rooms in your library. List your own room and earn</p>
