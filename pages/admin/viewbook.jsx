...
const ViewBooks = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(`${Server_URL}books/delete/${id}`, { withCredentials: true });
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(`${Server_URL}books/update/${selectedBook._id}`, formData, { withCredentials: true });
