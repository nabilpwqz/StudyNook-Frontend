...
function ProfilePage() {
  ...
  async function fetchProfile() {
    try {
      const response = await axios.get(`${Server_URL}users/profile`, { withCredentials: true });
  ...
  async function returnBook(borrowId) {
    try {
      const response = await axios.put(`${Server_URL}books/returnrequest/${borrowId}`, {}, { withCredentials: true });
