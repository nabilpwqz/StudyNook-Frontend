...
export default function Register(){
    ...
    return(
        ...
        <h2 className="text-center" style={{ color: '#F97316' }}>SN StudyNook</h2>
        <p className="text-center mb-4" style={{ color: '#EA580C' }}>Register your SN StudyNook account</p>
        <form onSubmit={handleSubmit(onSubmit)} className="p-4 border rounded shadow">
          ...
          <button type="submit" className="btn w-100 text-white" style={{ backgroundColor: '#F97316', borderColor: '#F97316' }}>Register</button>
        </form>
      </div>
    )
}